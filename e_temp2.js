    ...
    <style>
        ...
        *::after {
        ...
        :root {
            ...
            --blue-l: var(--primary-l);
            --blue-m: var(--primary-m);
            --navy: var(--text);
            --navy-m: #1E293B;
            --navy-l: #334155;
            --red: var(--danger);
            ...
            --red-m: var(--danger-m);
            --orange: var(--warning);
            --orange-l: var(--warning-l);
            --green: var(--success);
            --green-l: var(--success-l);
            --green-m: var(--success-m);
            --teal: #0EA5E9;
            --teal-l: #F0F9FF;
            --white: #FFFFFF;
            --s50: var(--bg);
            ...
            --sh-glow: 0 0 0 3px rgba(37, 99, 235, .12);
            --sh-primary: 0 4px 20px rgba(37, 99, 235, .30);
            --sh-danger: 0 4px 20px rgba(220, 38, 38, .35);
        ...
        [data-theme="dark"] {
            ...
            --primary-m: rgba(59, 130, 246, .28);
            --primary-text: #93C5FD;
            --success: #10B981;
            --success-l: rgba(16, 185, 129, .12);
            --success-m: rgba(16, 185, 129, .28);
            --success-text: #6EE7B7;
            --danger: #F87171;
            --danger-l: rgba(248, 113, 113, .12);
            --danger-m: rgba(248, 113, 113, .28);
            --danger-text: #FCA5A5;
            --warning: #FBBF24;
            --warning-l: rgba(251, 191, 36, .12);
            --warning-m: rgba(251, 191, 36, .28);
            --warning-text: #FDE68A;
            --bg: #0F172A;
            --card: #1E293B;
            --card-alt: #162032;
        ...
        .card.green {
            ...
            border-color: var(--success-m)
        }

        .card.red {
            background: var(--danger-l);
            border-color: var(--danger-m)
        }
        ...
        .lang-btn:hover {
            ...
            box-shadow: var(--sh), 0 0 0 3px rgba(37, 99, 235, .1);
            transform: translateY(-1px)
        }
        ...
        .lang-btn.selected {
            border-color: var(--primary);
            background: var(--primary-l);
            box-shadow: var(--sh), 0 0 0 3px rgba(37, 99, 235, .12)
        }
        ...
        .hn-select-btn .hn-val.placeholder {
            font-weight: 400;
            color: var(--text-3)
        }

        .hn-select-btn .hn-chevron {
        ...
        .mic-area::before {
            ...
            position: absolute;
            inset: 0;
            background: radial-gradient(ellipse at 50% 0%, rgba(37, 99, 235, .05) 0%, transparent 70%);
            pointer-events: none
        }
        ...
        @keyframes pulseMic {
            ...
            0%,
            100% {
                box-shadow: 0 4px 20px rgba(220, 38, 38, .35), 0 0 0 0 rgba(220, 38, 38, .2)
            }

            50% {
                box-shadow: 0 4px 20px rgba(220, 38, 38, .5), 0 0 0 18px rgba(220, 38, 38, 0)
            }
        }
        ...
        .waveform-bar:nth-child(1) {
            height: 7px;
            animation: wv 1.2s ease-in-out infinite 0s
        }

        .waveform-bar:nth-child(2) {
            height: 14px;
            animation: wv 1.2s ease-in-out infinite .1s
        }

        .waveform-bar:nth-child(3) {
            height: 22px;
            animation: wv 1.2s ease-in-out infinite .05s
        }

        .waveform-bar:nth-child(4) {
            height: 28px;
            animation: wv 1.2s ease-in-out infinite .15s
        }

        .waveform-bar:nth-child(5) {
            height: 20px;
            animation: wv 1.2s ease-in-out infinite .08s
        }

        .waveform-bar:nth-child(6) {
            height: 26px;
            animation: wv 1.2s ease-in-out infinite .2s
        }

        .waveform-bar:nth-child(7) {
            height: 18px;
            animation: wv 1.2s ease-in-out infinite .12s
        }

        .waveform-bar:nth-child(8) {
            height: 22px;
            animation: wv 1.2s ease-in-out infinite .06s
        }

        .waveform-bar:nth-child(9) {
            height: 14px;
            animation: wv 1.2s ease-in-out infinite .18s
        }

        .waveform-bar:nth-child(10) {
            height: 9px;
            animation: wv 1.2s ease-in-out infinite .25s
        }
        ...
        .transcript-box {
            background: var(--success-l);
            border: 1px solid var(--success-m);
            border-radius: var(--r);
            padding: 14px 16px;
            margin-bottom: 14px;
            display: none
        ...
        .consent-btn.yes.selected {
            border-color: var(--success);
            background: var(--success-l);
            color: var(--success-text)
        }

        .consent-btn.no.selected {
        ...
        .consent-btn.yes.selected .consent-dot {
            border-color: var(--success);
            background: var(--success)
        }

        .consent-btn.no.selected .consent-dot {
            border-color: var(--danger);
            background: var(--danger)
        }
        ...
        .triage-banner.emg {
            background: linear-gradient(135deg, var(--danger-l), #FEE2E2);
            border: 2px solid var(--danger-m)
        }

        .triage-banner.urg {
            background: linear-gradient(135deg, var(--warning-l), #FEF3C7);
            border: 2px solid var(--warning-m)
        }

        .triage-banner.rtn {
            background: linear-gradient(135deg, var(--success-l), #D1FAE5);
            border: 2px solid var(--success-m)
        }
        ...
        .triage-banner.emg .triage-title {
            color: var(--danger-text)
        }

        .triage-banner.urg .triage-title {
            color: var(--warning-text)
        }

        .triage-banner.rtn .triage-title {
            color: var(--success-text)
        }
        ...
        .hosp-card:hover {
            border-color: var(--primary-m);
            box-shadow: var(--sh), 0 0 0 3px rgba(37, 99, 235, .08);
            transform: translateY(-1px)
        }

        .hosp-card.best {
            border-color: var(--primary);
            background: linear-gradient(135deg, var(--primary-l), var(--card));
            box-shadow: var(--sh), 0 0 0 3px rgba(37, 99, 235, .1)
        }
        ...
        #waveformBars.active .sf-bar:nth-child(1) {
            animation-delay: 0.1s;
            animation-duration: 0.8s;
        }

        #waveformBars.active .sf-bar:nth-child(2) {
            animation-delay: 0.4s;
            animation-duration: 0.9s;
        }

        #waveformBars.active .sf-bar:nth-child(3) {
            animation-delay: 0.2s;
            animation-duration: 1.1s;
        }

        #waveformBars.active .sf-bar:nth-child(4) {
            animation-delay: 0.6s;
            animation-duration: 0.7s;
        }

        #waveformBars.active .sf-bar:nth-child(5) {
            animation-delay: 0.3s;
            animation-duration: 1.0s;
        }

        #waveformBars.active .sf-bar:nth-child(6) {
            animation-delay: 0.7s;
            animation-duration: 1.2s;
        }

        #waveformBars.active .sf-bar:nth-child(7) {
            animation-delay: 0.1s;
            animation-duration: 0.8s;
        }

        #waveformBars.active .sf-bar:nth-child(8) {
            animation-delay: 0.5s;
            animation-duration: 1.1s;
        }

        #waveformBars.active .sf-bar:nth-child(9) {
            animation-delay: 0.8s;
            animation-duration: 0.9s;
        }

        #waveformBars.active .sf-bar:nth-child(10) {
            animation-delay: 0.2s;
            animation-duration: 0.7s;
        }

        #waveformBars.active .sf-bar:nth-child(11) {
            animation-delay: 0.4s;
            animation-duration: 1.0s;
        }

        #waveformBars.active .sf-bar:nth-child(12) {
            animation-delay: 0.6s;
            animation-duration: 0.8s;
        }

        #waveformBars.active .sf-bar:nth-child(13) {
            animation-delay: 0.3s;
            animation-duration: 1.1s;
        }

        #waveformBars.active .sf-bar:nth-child(14) {
            animation-delay: 0.1s;
            animation-duration: 0.9s;
        }

        .complaint-chip.selected {
            background: var(--primary);
            color: #fff;
        ...
        /* --- V5 MODERN MEDICAL UI ENHANCEMENTS --- */
        :root {
            --primary: #0A84FF;
            /* iOS Medical Blue */
            --success: #30D158;
        ...
        .hosp-card.best {
            ...
            background: linear-gradient(145deg, var(--card) 0%, rgba(10, 132, 255, 0.05) 100%) !important;
        }
        ...
        /* Boarding Pass Design for Result Page */
        .digital-pass {
            background: var(--card);
            border-radius: 28px;
            overflow: hidden;
        ...
        /* ══ v5 ELEGANT UI ENHANCEMENTS ══ */
        :root {
            --ios-bg: #F2F2F7;
            --ios-card: #FFFFFF;
            --medical-blue: #0A84FF;
            --accent-blue: rgba(10, 132, 255, 0.1);
        ...
        [data-theme="dark"] {
            --ios-bg: #000000;
            --ios-card: #1C1C1E;
            --accent-blue: rgba(10, 132, 255, 0.15);
            --soft-shadow: 0 12px 40px rgba(0, 0, 0, 0.4);
        }
        ...
        .digital-pass {
            ...
            /* Perforation holes logic */
            mask-image: radial-gradient(circle at 0 72%, transparent 12px, black 13px),
                radial-gradient(circle at 100% 72%, transparent 12px, black 13px);
            -webkit-mask-image: radial-gradient(circle at 0 72%, transparent 12px, black 13px),
                radial-gradient(circle at 100% 72%, transparent 12px, black 13px);
        }
        ...
        .btn-primary {
            ...
            box-shadow: 0 12px 24px rgba(10, 132, 255, 0.3) !important;
        }
...
<body>
    <div class="app">
        <div class="topbar">
            <div class="topbar-logo">
                <img class="topbar-logo-img" id="topbarLogoImg" src="/docs/images/logo_v2.png" alt="VitalNavAI"
                    onerror="this.style.display='none';document.getElementById('topbarLogoFallback').style.display='flex'">
                <div id="topbarLogoFallback"
                    style="width:45px;height:45px;border-radius:8px;background:var(--primary-l);border:1px solid var(--primary-m);display:none;align-items:center;justify-content:center;color:var(--primary);flex-shrink:0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M22 12h-4l-3 9L9 3l-3 9H2" />
                    </svg>
                </div>
                <span style="font-weight:800;font-size:.95rem;letter-spacing:-.02em;margin-left:8px;"><span
                        style="color:#DC2626">Vital</span><span style="color:#38BDF8">Nav</span><span
                        style="color:#4ADE80">AI</span></span>
            </div>
            <div class="topbar-right">
                <div id="topbarLangBadge" class="topbar-lang">EN</div>
                <button class="topbar-theme" id="themeToggleBtn" onclick="toggleTheme()" aria-label="Toggle dark mode"
                    ...
                    <svg id="themeIconMoon" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <div class="page active" id="page-lang">
            <div class="lang-hero">
                <div class="lang-hero-icon">
                    <img src="/docs/images/logo_v2.png" alt="VitalNavAI"
                        onerror="this.parentElement.innerHTML='<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'44\' height=\'44\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'%232563EB\' stroke-width=\'2\' stroke-linecap=\'round\' stroke-linejoin=\'round\'><path d=\'M22 12h-4l-3 9L9 3l-3 9H2\'/></svg>'">
                </div>
                <p id="wl_langHeroSub">AI Emergency Assistant</p>
            </div>
            <p style="font-size:.9rem;font-weight:600;color:var(--text-2);text-align:center;margin-bottom:18px">Select
                your language / Sprache wählen / Dil seçin</p>
            <div class="lang-grid">
                <button class="lang-btn" onclick="selectLanguage('en')" id="langBtn_en">
                    <span class="lang-flag">🇬🇧</span>
                    <div><span class="lang-name">English</span><span class="lang-sub">Medical emergency assistant</span>
                    </div>
                ...
                <button class="lang-btn" onclick="selectLanguage('de')" id="langBtn_de">
                    <span class="lang-flag">🇩🇪</span>
                    <div><span class="lang-name">Deutsch</span><span class="lang-sub">Medizinischer
                            Notfallassistent</span></div>
                    <span class="lang-arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M9 18l6-6-6-6" />
                ...
                <button class="lang-btn" onclick="selectLanguage('tr')" id="langBtn_tr">
                    <span class="lang-flag">🇹🇷</span>
                    <div><span class="lang-name">Türkçe</span><span class="lang-sub">Tıbbi acil asistan</span></div>
                    <span class="lang-arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M9 18l6-6-6-6" />
        ...
        <div class="page" id="page-welcome">
            ...
            <div class="card blue" style="margin-bottom:14px">
                <div class="label" id="wl_whatLabel"></div>
                <p id="wl_whatDesc"
                    style="font-size:.88rem;color:var(--primary-text);line-height:1.6;margin-bottom:12px">
                </p>
                <div>
                    <div class="benefit-row">
                        ...
                        <span id="wl_b1" style="font-size:.88rem;color:var(--primary-text);line-height:1.5"></span>
                    </div>
                    <div class="benefit-row">
                        <div class="benefit-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        ...
                        <span id="wl_b2" style="font-size:.88rem;color:var(--primary-text);line-height:1.5"></span>
                    </div>
                    <div class="benefit-row">
                        <div class="benefit-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        ...
                        <span id="wl_b3" style="font-size:.88rem;color:var(--primary-text);line-height:1.5"></span>
                    </div>
                </div>
            </div>
            <div class="card" style="margin-bottom:16px">
                <div class="label" id="wl_howLabel"></div>
                <div style="display:flex;flex-direction:column;gap:12px">
                    <div style="display:flex;align-items:flex-start;gap:12px">
                        <div class="step-num">1</div><span id="wl_s1"
                            style="font-size:.88rem;color:var(--text-2);line-height:1.5"></span>
                    </div>
                    <div style="display:flex;align-items:flex-start;gap:12px">
                        <div class="step-num">2</div><span id="wl_s2"
                            style="font-size:.88rem;color:var(--text-2);line-height:1.5"></span>
                    </div>
                    <div style="display:flex;align-items:flex-start;gap:12px">
                        <div class="step-num">3</div><span id="wl_s3"
                            style="font-size:.88rem;color:var(--text-2);line-height:1.5"></span>
                    </div>
                </div>
            </div>
            <div class="hn-wrap">
                <div class="hn-label">
                    ...
                    <span id="wl_hnLabel"></span><span class="req" id="wl_hnReq"></span>
                </div>
                <button class="hn-select-btn" id="hnSelectBtn" onclick="toggleHnDropdown()">
                    ...
                    <span class="hn-val placeholder" id="hnSelectVal" data-placeholder="true"></span>
                ...
                <div class="hn-hint">
                    ...
                    <span id="wl_hnHintText"></span>
                </div>
            </div>
            <button class="btn btn-primary" id="btnStart" onclick="startApp()"></button>`n <p
                style="text-align:center;font-size:0.85rem;color:var(--text-2);margin-top:16px;">This system has been
                developed to determine medical priorities.</p>
        ...
        <div id="page-input" class="page">
            <div style="margin-bottom: 30px; text-align: center; padding: 0 10px;">
                <h2 style="font-size: 1.6rem; font-weight: 800; margin-bottom: 8px; color: var(--text);">Nasıl
                    hissediyorsunuz?</h2>
                <p style="color: var(--text-2); font-size: 0.95rem; opacity: 0.8;">Durumunuzu sesli, seçerek veya
                    yazarak bildirin.</p>
            </div>

            <div class="card"
                style="padding: 30px 20px; margin-bottom: 35px; border: 2px solid var(--medical-blue); position: relative; overflow: hidden; background: var(--ios-card);">
                <div
                    style="position: absolute; top: 12px; right: 15px; font-size: 0.6rem; font-weight: 900; color: var(--medical-blue); letter-spacing: 1.5px; text-transform: uppercase;">
                    En Hızlı Yol</div>

                <div id="voiceUI" style="display: flex; flex-direction: column; align-items: center; gap: 20px;">
                    <button id="micBtn" class="mic-btn" onclick="toggleRecording()"
                        style="width: 80px; height: 80px; border-radius: 50%; background: var(--medical-blue); border: none; color: white; display: flex; align-items: center; justify-content: center; box-shadow: 0 10px 25px rgba(10, 132, 255, 0.4); cursor: pointer; transition: transform 0.2s;">
                        <i data-lucide="mic" style="width: 35px; height: 35px;"></i>
                    </button>

                    <div style="text-align: center;">
                        <div id="micStatus" style="font-weight: 800; font-size: 1.2rem; color: var(--text);">Dokun ve
                            Konuş</div>
                        <div style="font-size: 0.85rem; color: var(--text-2); margin-top: 6px; opacity: 0.7;">Kendi
                            dilinizde şikayetinizi anlatın.</div>
                    </div>
                </div>

                <div id="waveformBars" class="waveform"
                    style="justify-content: center; align-items: center; gap: 5px; height: 40px; margin-top: 20px; display: flex;">
            ...
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 25px; opacity: 0.5;">
                <div style="flex: 1; height: 1px; background: var(--border);"></div>
                <span
                    style="font-size: 0.65rem; font-weight: 800; color: var(--text-3); text-transform: uppercase; letter-spacing: 2px;">Veya
                    Belirti Seçin</span>
                <div style="flex: 1; height: 1px; background: var(--border);"></div>
            </div>
            ...
            <div style="margin-top: 35px;">
                <div
                    style="margin-bottom: 12px; font-size: 0.85rem; font-weight: 700; color: var(--text-2); display: flex; align-items: center; gap: 6px;">
                    <i data-lucide="pen-line" style="width: 16px; height: 16px;"></i> Eklemek istediğiniz detaylar:
                </div>
                <div id="transcriptBox"
                    style="display:none; background:rgba(10,132,255,0.1); padding:15px; border-radius:15px; margin-bottom:15px; border:1px solid var(--medical-blue);">
                    <div id="transcriptLang"
                        style="font-size:0.7rem; font-weight:800; color:var(--medical-blue); text-transform:uppercase; margin-bottom:5px;">
                        ✓ Azure AI Transcript</div>
                    <div id="transcriptText" style="font-size:0.95rem; font-weight:600; color:var(--text);"></div>
                </div>
                <textarea id="complaintText" class="form-control" rows="3" oninput="onComplaintType()"
                    style="width: 100%; border-radius: 18px; padding: 15px; border: 1px solid var(--border); background: var(--ios-card); color: var(--text); font-family: inherit; resize: none;"
                    placeholder="Örn: Ağrı 15 dakika önce başladı, sol koluma yayılıyor..."></textarea>
            </div>

            <button class="btn btn-primary" id="btnContinueInput" onclick="submitComplaint()"
                style="width: 100%; margin-top: 30px; height: 60px; border-radius: 20px; font-weight: 800; font-size: 1.1rem; display: flex; align-items: center; justify-content: center; gap: 10px;">
        ...
        <div class="page" id="page-photos">
            <h2 id="ph_title"></h2>
            <p class="sub" id="ph_sub"></p>
            <div class="photo-guide">
                <div class="photo-guide-frame">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path
                            d="M5 3H3a2 2 0 0 0-2 2v2M19 3h2a2 2 0 0 1 2 2v2M5 21H3a2 2 0 0 1-2-2v-2M19 21h2a2 2 0 0 0 2-2v-2" />
                    </svg>
                </div>

            </div>
            <button class="btn btn-secondary" onclick="goToPage('input')" style="margin-bottom:16px;height:44px;"><svg
                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M15 18l-6-6 6-6" />
                </svg><span id="ph_backBtn">Back</span></button>
            <div class="media-grid" id="mediaGrid"></div>
            <div class="media-add-row" id="mediaAddRow">
                <label class="media-add-btn" style="cursor:pointer">
                    <span class="icon">
                    ...
                    <span id="ph_addPhoto"></span>
                    <input type="file" id="photoInput" accept="image/*" capture="environment"
                        onchange="onMediaAdded(event,'photo')" style="display:none">
                </label>
                <label class="media-add-btn" style="cursor:pointer">
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none"
                    ...
                    <span id="ph_addVideo"></span>
                    <input type="file" id="videoInput" accept="video/*" capture="environment"
                        onchange="onMediaAdded(event,'video')" style="display:none">
                </label>
            </div>
            <p style="font-size:.78rem;color:var(--text-3);text-align:center;margin-bottom:8px" id="mediaCount">0 / 3
            </p>
            <div class="divider"></div>
            <div class="row">
                <button class="btn btn-secondary" onclick="skipPhotos()" id="ph_skip"></button>
                <button class="btn btn-primary" onclick="continueFromPhotos()" id="ph_continue"></button>
            </div>
        </div>

        <!-- PAGE: QUESTIONS -->
        <div class="page" id="page-questions">
            <div class="card" style="margin-bottom:16px;background:var(--primary-l);border-color:var(--primary-m)"
                id="qIntroCard">
                <p id="qIntroText" style="font-size:.9rem;color:var(--primary-text);line-height:1.6;font-weight:500">
                </p>
            </div>
            <div class="spinner-wrap visible" id="questionsSpinner" style="padding:28px 0">
                <div class="spinner"></div>
                <div class="spinner-text" id="questionsSpinnerText"></div>
            </div>
            <div id="aiModeBadge" style="display:none;margin-bottom:14px">
                <div class="ai-badge" id="aiModeBadgeInner">
                    <div id="aiBadgeDot" style="width:6px;height:6px;border-radius:50%;flex-shrink:0"></div>
                    <span id="aiBadgeText"></span>
                </div>
            </div>
            <!-- Chat-bubble question display area -->
            <div id="chatAiQuestion" class="chat-ai" style="display:none">
                ...
                <div class="chat-ai-bubble" id="chatAiBubbleText"></div>
            </div>
        ...
        <div class="page" id="page-consent">
            <div style="text-align:center;padding:8px 0 18px">
                <div
                    style="width:56px;height:56px;border-radius:18px;background:var(--primary-l);border:1.5px solid var(--primary-m);display:flex;align-items:center;justify-content:center;margin:0 auto 12px;color:var(--primary)">
                ...
                <h2 id="cs_title"></h2>
                <p class="sub" id="cs_sub"></p>
            </div>
            <div class="card" style="margin-bottom:16px">
                <div class="label" id="cs_consentLabel"></div>
                <p id="cs_consentDesc" style="font-size:.88rem;color:var(--text-2);margin-bottom:14px;line-height:1.5">
                </p>
                <div>
                    <div class="consent-item">
                        <div class="consent-icon" style="background:var(--primary-l);color:var(--primary)">
                        ...
                        <span id="cs_line1" style="font-size:.88rem;color:var(--text-2)"></span>
                    </div>
                    <div class="consent-item">
                        <div class="consent-icon" style="background:var(--success-l);color:var(--success-text)">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                        ...
                        <span id="cs_photoLine" style="font-size:.88rem;color:var(--text-2)"></span>
                    </div>
                    <div class="consent-item">
                        <div class="consent-icon" style="background:var(--warning-l);color:var(--warning-text)">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                                <path d="M12 2a10 10 0 0 1 10 10 10 10 0 0 1-10 10A10 10 0 0 1 2 12 10 10 0 0 1 12 2" />
                        ...
                        <span id="cs_line3" style="font-size:.88rem;color:var(--text-2)"></span>
                    </div>
                    <div class="consent-item">
                        <div class="consent-icon" style="background:var(--danger-l);color:var(--danger-text)">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                        ...
                        <span id="cs_line4" style="font-size:.88rem;color:var(--text-2)"></span>
                    </div>
                </div>
            </div>
            <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:14px">
                <button class="consent-btn yes" id="consentYes" onclick="setConsent(true)">
                    <div class="consent-dot" id="consentYesDot"></div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        style="color:var(--success)">
                        <polyline points="20 6 9 17 4 12" />
                    </svg>
                    <span id="cs_yesLabel"></span>
                </button>
                <p style="text-align:center; font-size:0.85rem; color:var(--text-2); margin-top:8px;">Your data is
                    processed securely.</p>
            </div>
            <p class="consent-warning" id="consentWarning">
                ...
                <span id="consentWarningTxt"></span>
            </p>
            <div class="spinner-wrap" id="assessSpinner">
                <div class="spinner"></div>
                <div class="spinner-text" id="assessSpinnerText"></div>
            </div>
            <button class="btn btn-primary" id="btnGetAssessment" onclick="submitConsent()" style="margin-top:8px">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M22 12h-4l-3 9L9 3l-3 9H2" />
                </svg>
                <span id="cs_submitLabel"></span>
            </button>
        </div>
        ...
        <div class="page" id="page-triage">
            ...
            <div id="triageAdviceSection" style="display:none">
                <h2 id="tr_adviceLabel" style="margin-bottom:12px;display:flex;align-items:center;gap:8px">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M22 12h-4l-3 9L9 3l-3 9H2" />
                    </svg>
            ...
            <div class="divider"></div>
            <h2 id="tr_nearestLabel" style="margin-bottom:12px;display:flex;align-items:center;gap:8px">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                    <polyline points="9 22 9 12 15 12 15 22" />
            ...
            <div class="gps-status wait" id="gpsStatusPill">
                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                    <circle cx="12" cy="12" r="10" />
                    <polyline points="12 6 12 12 16 14" />
                </svg>
                <span id="gpsStatusTxt"></span>
            </div>
            <div id="gpsWaiting"
                style="display:none;text-align:center;padding:16px 0;color:var(--text-3);font-size:.88rem">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                    style="margin:0 auto 8px;display:block;animation:spin 2s linear infinite;color:var(--primary)">
                    <circle cx="12" cy="12" r="10" />
                    <polyline points="12 6 12 12 16 14" />
                </svg>
                <span id="gps_waitText"></span>
                <p id="gps_privacy"
                    style="text-align:center; font-size:0.8rem; color:var(--text-3); margin-top:12px; padding:0 24px; line-height:1.4;">
                    Your location is only used to find you the most suitable hospital and your identity
                    is kept confidential.</p>
            </div>
            <div id="gpsDenied" style="display:none">
                <div class="card red">
                    <p
                        style="font-size:.95rem;font-weight:700;color:var(--danger-text);margin-bottom:8px;display:flex;align-items:center;gap:6px">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
                            <circle cx="12" cy="10" r="3" />
                        </svg>
                        <span id="gps_deniedTitle"></span>
                    </p>
                    <p id="gps_deniedDesc"
                        style="font-size:.85rem;color:var(--danger-text);margin-bottom:12px;opacity:.8">
                    </p>
                    <div id="gps_deniedSteps"
                        style="font-size:.82rem;color:var(--danger-text);opacity:.8;margin-bottom:12px">
                    </div>
                    <button class="btn btn-secondary" onclick="retryGPS()" id="gps_retryBtn"
        ...
        <div class="page" id="page-result">
            <!-- Dynamic content populated by renderResult() -->
        </div>
    ...
    <div id="toast"></div>
        ...
        const symptoms = [
            { id: 'chest_pain', label: 'Göğüs Ağrısı' },
            { id: 'shortness_breath', label: 'Nefes Darlığı' },
            { id: 'headache', label: 'Şiddetli Baş Ağrısı' },
            { id: 'fever', label: 'Yüksek Ateş' },
            { id: 'dizziness', label: 'Baş Dönmesi' },
            { id: 'abdominal_pain', label: 'Karın Ağrısı' },
            { id: 'swelling', label: 'Bacak Şişliği' },
            { id: 'fainting', label: 'Bayılma' }
        ];
        ...
        function toggleSymptom(el, id) {
            ...
            S.complaint = selectedTexts.join(', ');

            const manualTxt = document.getElementById('complaintText').value.trim();
            if (manualTxt) {
                S.complaint = S.complaint ? S.complaint + ', ' + manualTxt : manualTxt;
            }
        ...
        const TX = {
            en: {
                ...
                wl_demo: '⚠️ Demo only. Call 112 for real emergencies.',
                wl_hnLabel: 'Select your health record', wl_hnReq: 'REQUIRED',
                wl_hnHintText: 'Your medical history will be linked to this visit',
                btnStart: 'Start →',
                inp_title: 'Describe your symptoms',
                inp_sub: 'Tap the microphone and speak freely — or type below.',
                micLabelIdle: 'Tap to record', micSubIdle: 'Speak clearly in your own language',
                micLabelRec: 'Recording…', micSubRec: 'Tap again to stop',
                micLabelDone: 'Tap to re-record', micSubDone: 'Or edit the text above',
                transcriptLang: '✓ Captured',
                inp_orType: 'or type instead',
                inp_placeholder: 'e.g. Sudden chest pain, difficulty breathing, started 20 min ago…',
                inp_continueTxt: 'Continue →',
                ...
                ph_sub: 'Optional — wound, rash, swelling, or a short video clip. Helps the hospital prepare.',
                ph_addPhoto: '📷 Photo', ph_addVideo: '🎥 Video', ph_skip: 'Skip →', ph_continue: 'Continue →',
                ...
                rs_tab_status: '🎫 Status', rs_tab_instructions: '📋 Instructions', rs_tab_contact: '👥 Contact',
            ...
            de: {
                ...
                wl_demo: '⚠️ Nur Demo. Im Notfall 112 anrufen.',
                ...
                inp_sub: 'Tippen Sie auf das Mikrofon und sprechen Sie frei — oder tippen Sie unten.',
                micLabelIdle: 'Zum Aufnehmen tippen', micSubIdle: 'Sprechen Sie deutlich in Ihrer Sprache',
                micLabelRec: 'Aufnahme läuft…', micSubRec: 'Zum Stoppen erneut tippen',
                micLabelDone: 'Erneut aufnehmen', micSubDone: 'Oder Text oben bearbeiten',
                transcriptLang: '✓ Aufgezeichnet',
                inp_orType: 'oder stattdessen tippen',
                inp_placeholder: 'z.B. Plötzliche Brustschmerzen, Atemnot, seit 20 Minuten…',
                inp_continueTxt: 'Weiter →',
                ...
                ph_sub: 'Optional — Wunde, Ausschlag, Schwellung oder ein kurzer Videoclip.',
                ph_addPhoto: '📷 Foto', ph_addVideo: '🎥 Video', ph_skip: 'Überspringen →', ph_continue: 'Weiter →',
                ...
                rs_tab_status: '🎫 Status', rs_tab_instructions: '📋 Anweisungen', rs_tab_contact: '👥 Kontakt',
            ...
            tr: {
                ...
                wl_demo: "⚠️ Yalnızca demo. Gerçek acillerde 112'yi arayın.",
                wl_hnLabel: 'Sağlık kaydınızı seçin', wl_hnReq: 'ZORUNLU',
                wl_hnHintText: 'Tıbbi geçmişiniz bu ziyaretle ilişkilendirilecek',
                btnStart: 'Başlayın →',
                inp_title: 'Belirtilerinizi anlatın',
                inp_sub: 'Mikrofona dokunun ve özgürce konuşun — ya da aşağıya yazın.',
                micLabelIdle: 'Kaydetmek için dokunun', micSubIdle: 'Kendi dilinizde açıkça konuşun',
                micLabelRec: 'Kaydediliyor…', micSubRec: 'Durdurmak için tekrar dokunun',
                micLabelDone: 'Tekrar kaydedin', micSubDone: 'Ya da yukarıdaki metni düzenleyin',
                transcriptLang: '✓ Kaydedildi',
                inp_orType: 'veya yazarak girin',
                inp_placeholder: 'Örn: Ani göğüs ağrısı, nefes darlığı, 20 dakika önce başladı…',
                inp_continueTxt: 'Devam →',
                ...
                ph_sub: 'İsteğe bağlı — yara, döküntü, şişlik veya kısa bir video. Hastanenin hazırlık yapmasına yardımcı olur.',
                ph_addPhoto: '📷 Fotoğraf', ph_addVideo: '🎥 Video', ph_skip: 'Atla →', ph_continue: 'Devam →',
                ...
                rs_tab_status: '🎫 Durum', rs_tab_instructions: '📋 Talimatlar', rs_tab_contact: '👥 İletişim',
                rs_openNav: 'Navigasyonu Aç', rs_liveTrackingTitle: 'CANLI TAKİP AKTİF', rs_liveTrackingSub: 'Sağlık ekibi varışınızı GPS ile izliyor.', rs_passFooter: 'Varışta bu kartı triyaj hemşiresine derhal gösterin.',
        ...
        function applyLang() {
            ...
            ['wl_whatLabel', 'wl_whatDesc', 'wl_b1', 'wl_b2', 'wl_b3', 'wl_howLabel', 'wl_s1', 'wl_s2', 'wl_s3', 'wl_demo',
                ...
                'rs_trackTitle', 'rs_trackSub', 'rs_newBtn', 'rs_demo'].forEach(id => {
                    const el = document.getElementById(id); if (el) el.innerHTML = t(id);
                });
            // textContent elements
            ['inp_title', 'inp_sub', 'inp_orType', 'inp_continueTxt', 'ph_title', 'ph_sub',
                'ph_addPhoto', 'ph_addVideo', 'ph_skip', 'ph_continue', 'wl_hnLabel', 'wl_hnReq',
                'wl_hnHintText', 'btnStart',
                // Back buttons
                'inp_backBtn', 'ph_backBtn',
                // Language page hero sub
                'wl_langHeroSub',
                // GPS privacy note
                'gps_privacy',
                // Result page: preliminary notice
                'rs_prelimNotice',
                // Result page: contact person card
                'rs_contactTitle', 'rs_contactDesc',
                'rs_contactItem1', 'rs_contactItem2', 'rs_contactItem3',
                'rs_contactSendBtn',
                // Consent page: secure text
                'cs_secureText'
            ].forEach(id => {
                const el = document.getElementById(id); if (el) el.textContent = t(id);
            });
            // GPS privacy note uses different key name
            ...
            const ms = document.getElementById('micSub'); if (ms) ms.textContent = t('micSubIdle');
        ...
        function selectLanguage(lang) {
            ...
            S.healthNumber = null;
            ['en', 'de', 'tr'].forEach(l => document.getElementById('langBtn_' + l).classList.toggle('selected', l === lang));
            applyLang();
            setTimeout(() => { goToPage('welcome'); checkAIStatus(); }, 180);
        }
      ...
      <div><div class="hn-item-name">${escHtml(p.name)}</div><div class="hn-item-detail">${escHtml(p.detail)}</div></div>
        ...
        function setMicState(state) {
            ...
            if (state === 'recording') {
                ...
                if (subTxt) subTxt.textContent = S.complaint ? t('micSubDone') : t('micSubIdle');
            }
        }
        async function processAudio() {
            ...
            if (inputSpinner) inputSpinner.classList.add('visible');
            ...
            if (blob.size > 500) {
                try {
                    ...
                    if (d.text && d.text.trim().length > 0) {
                        setComplaintFromAudio(d.text.trim(), d.language || S.selectedLang);
                    }
                } catch (e) {
                    console.error("Server transcription failed:", e);
                    if (!wsr) toast('Ses işlenemedi, lütfen yazarak anlatın.', 'warn');
                }
            } else if (!wsr) {
                toast('Ses algılanamadı, lütfen daha uzun konuşun.', 'warn');
            }

            if (inputSpinner) inputSpinner.classList.remove('visible');
            webSpeechResult = '';
        }

        // Web Speech empty or very short — try server transcription (Whisper/Azure)
        document.getElementById('inputSpinner').classList.add('visible');
        const proc = { en: 'Processing audio…', de: 'Audio wird verarbeitet…', tr: 'Ses işleniyor…' };
        document.getElementById('inputSpinnerText').textContent = proc[S.lang] || proc.en;
        try {
            const form = new FormData(); form.append('audio', blob, 'complaint.webm');
            const r = await fetch(API + '/api/patient/transcribe', { method: 'POST', body: form });
            const d = await r.json();
            if (d.text && d.text.trim()) {
                ...
                // Last resort: use whatever Web Speech got
                setComplaintFromAudio(wsr, S.selectedLang || S.detectedLang);
                webSpeechResult = '';
            } else {
                const m = { en: 'Could not understand audio — please type.', de: 'Audio nicht verstanden — bitte tippen.', tr: 'Ses anlaşılamadı — lütfen yazın.' };
                toast(m[S.lang] || m.en, 'warn'); setMicState('idle');
            }
        } catch (e) {
            if (wsr) { setComplaintFromAudio(wsr, S.selectedLang || S.detectedLang); }
            else { const m = { en: 'Could not process audio — please type.', de: 'Audio konnte nicht verarbeitet werden.', tr: 'Ses işlenemedi — lütfen yazın.' }; toast(m[S.lang] || m.en, 'warn'); setMicState('idle'); }
            webSpeechResult = '';
        } finally { document.getElementById('inputSpinner').classList.remove('visible'); }
        }
        ...
        function setComplaintFromAudio(text, langCode) {
            ...
            S.complaint = text.trim();

            const transcriptText = document.getElementById('transcriptText');
            const transcriptBox = document.getElementById('transcriptBox');
            const complaintTextArea = document.getElementById('complaintText');

            if (transcriptText) transcriptText.textContent = S.complaint;
            if (transcriptBox) transcriptBox.style.display = 'block'; // 'visible' class'ı bazen CSS'de takılabiliyor
            if (complaintTextArea) complaintTextArea.value = S.complaint; // Metni textarea içine de basalım ki kullanıcı görsün

            enableContinue(true);
            setMicState('idle');

            toast(t('transcriptLang'), 'ok');
        }
    ...
    <div class="${type === 'scale' ? '' : 'radio-group'}" id="qOptions"></div>`;
        ...
        function renderTriageBanner() {
            ...
            if (lvl === 'EMERGENCY') html += `<a href="tel:112" class="btn btn-danger" style="margin-bottom:12px;font-size:1.1rem">📞 CALL 112</a><p style="text-align:center;font-size:.8rem;color:var(--s400);margin-bottom:12px">— ${t('tr_orBelow')} —</p>`;
            document.getElementById('triageBanner').innerHTML = html;
            let doList = a.do_list || [], dontList = a.dont_list || [];
            if (!doList.length && !dontList.length) { const fb = buildFallbackAssessment(S.complaint || '', S.answers); doList = fb.do_list; dontList = fb.dont_list; }
            renderAdviceBlock('triageAdviceContent', doList, dontList, lvl);
            document.getElementById('triageAdviceSection').style.display = 'block';
            document.getElementById('tr_adviceLabel').textContent = t('tr_adviceLabel');
        }
        ...
        function renderHospitals() {
            ...
            hl.innerHTML = S.hospitals.map((h, i) => {
                const isLive = h.source && h.source.includes('azure');
                const colors = { low: '#30D158', medium: '#FF9F0A', high: '#FF453A', full: '#8E8E93' };
                const dotColor = colors[h.occupancy] || colors.medium;

                return `
                <div class="hosp-card ${i === 0 ? 'best' : ''}" onclick="selectHospital(${i})">
                    ${i === 0 ? `<div class="best-badge">BEST CHOICE</div>` : ''}
                    <div class="hosp-name">${h.name}</div>
                    <div class="hosp-meta">
                        <div class="hosp-chip">
                            <i data-lucide="ruler" style="width:14px; height:14px; margin-right:4px;"></i> 
                            ${h.distance_km} km
                        </div>
                        <div class="hosp-chip" style="${i === 0 ? 'color:var(--medical-blue); font-weight:800;' : ''}">
                            <i data-lucide="clock" style="width:14px; height:14px; margin-right:4px;"></i> 
                            ~${h.eta_minutes} min
                        </div>
                        <div class="hosp-chip">
                            <span style="width:8px; height:8px; background:${dotColor}; border-radius:50%; display:inline-block; margin-right:5px; box-shadow: 0 0 5px ${dotColor}"></span>
                            ${h.occupancy_label}
                        </div>
                    </div>
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-top:8px;">
                        <div class="hosp-addr" style="display:flex; align-items:center; gap:4px; font-size:0.75rem;">
                            <i data-lucide="map-pin" style="width:12px; height:12px; color:var(--medical-blue)"></i>
                            ${h.address || ''}
                        </div>
                        <div style="font-size:0.65rem; font-weight:700; display:flex; align-items:center; gap:4px;">
                            <i data-lucide="${isLive ? 'zap' : 'calculator'}" style="width:10px; height:10px;"></i>
                            ${isLive ? 'LIVE TRAFFIC' : 'ESTIMATED'}
                        </div>
                    </div>
                </div>`;
            }).join('');
        ...
        function renderResult() {
            ...
            resultPage.innerHTML = `
                ...
                <div class="result-tabs">
                    <button class="result-tab-btn active" onclick="switchResultTab(0)">
                        <i data-lucide="activity" style="width:14px; height:14px; margin-right:6px; color:var(--primary);"></i>
                        ${t('rs_tab_status')}
                    </button>
                    <button class="result-tab-btn" onclick="switchResultTab(1)">
                        <i data-lucide="clipboard-list" style="width:14px; height:14px; margin-right:6px; color:var(--orange);"></i>
                        ${t('rs_tab_instructions')}
                    </button>
                    <button class="result-tab-btn" onclick="switchResultTab(2)">
                        <i data-lucide="users" style="width:14px; height:14px; margin-right:6px; color:var(--success);"></i>
                        ${t('rs_tab_contact')}
                    </button>
                </div>
                ...
                <div class="result-tab-panel active" id="resultTab0">
                    ...
                    <div class="digital-pass" style="margin-bottom: 24px;">
                        ...
                        <div style="padding: 24px 20px; text-align: center;">
                            <div style="display: flex; flex-direction: column; align-items: center; margin-bottom: 16px;">
                                ...
                                <div style="font-size: 0.65rem; color: var(--text-2); font-weight: 700; letter-spacing: 1px; text-transform: uppercase;">Patient Identifier</div>
                            ...
                            <div style="background: var(--ios-bg); display: inline-block; padding: 12px; border-radius: 18px; margin-bottom: 20px; border: 1px solid var(--border);">
                                <img src="${qrUrl}" alt="QR" style="width:130px; height:130px; border-radius:8px; display: block;">
                            </div>

                            <div style="border-top: 2px dashed var(--ios-bg); margin: 0 -20px 20px; position: relative;"></div>

                            <div style="display: flex; align-items: center; justify-content: center; gap: 8px; color: var(--text-2); font-size: 0.8rem; font-weight: 600;">
                                <i data-lucide="scan-face" style="width:16px; height:16px; color:var(--medical-blue)"></i>
                                ${t('rs_passFooter')}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card" style="margin-bottom:16px; border-left: 6px solid var(--success) !important;">
                        ...
                        <div style="display:flex; gap:8px; flex-wrap:wrap; padding-left: 26px;">
                            <span class="hosp-chip" style="display:flex; align-items:center; gap:4px;">
                                <i data-lucide="navigation" style="width:12px; height:12px;"></i> ${ht.distance_km} km
                            </span>
                            <span class="hosp-chip" style="display:flex; align-items:center; gap:4px; color:var(--medical-blue); font-weight:700;">
                                <i data-lucide="timer" style="width:12px; height:12px;"></i> ~${ht.eta_minutes} min
                            </span>
                            <span class="hosp-chip" style="display:flex; align-items:center; gap:4px;">
                                <i data-lucide="info" style="width:12px; height:12px;"></i> ${escHtml(ht.occupancy_label || '')}
                            </span>
                        </div>
                    </div>

                    <button class="btn btn-secondary" onclick="window.open('https://www.google.com/maps/dir/?api=1&destination=${ht.lat},${ht.lon}')" style="margin-bottom:16px; gap:8px; border-color:var(--medical-blue); color:var(--medical-blue); font-weight:700;">
                        <i data-lucide="map-pin" style="width:18px; height:18px;"></i>
                        ${t('rs_openNav')}
                    </button>

                    <div class="card" style="background:var(--accent-blue) !important; border:none; text-align:center; padding:15px !important;">
                        <div style="display:flex; align-items:center; justify-content:center; gap:10px;">
                            <div class="live-glow"></div>
                            <span style="font-weight:800; font-size:14px; color:var(--medical-blue); display:flex; align-items:center; gap:6px;">
                                <i data-lucide="radio" style="width:16px; height:16px;"></i>
                                ${t('rs_liveTrackingTitle')}
                            </span>
                        </div>
                        <p style="font-size:12px; color:var(--medical-blue); opacity:0.8; margin:4px 0 0;">${t('rs_liveTrackingSub')}</p>
                    </div>
                </div>

                <div class="result-tab-panel" id="resultTab1">
                    <div style="text-align:center; font-size:0.8rem; color:var(--warning-text); background:var(--warning-l); padding:12px; border-radius:14px; margin-bottom:16px; border:1px solid var(--warning-m); display:flex; align-items:center; gap:8px;">
                        <i data-lucide="alert-triangle" style="width:20px; height:20px; flex-shrink:0;"></i>
                        <span>${t('rs_prelimNotice')}</span>
                    </div>
                ...
                <div class="result-tab-panel" id="resultTab2">
                    <div class="card" style="margin-bottom:16px; border:none; background:var(--blue-light);">
                        ...
                        <p style="font-size:.82rem; color:var(--text-2); margin-bottom:15px; line-height:1.4;">
                            ${t('rs_contactDesc')}
                        </p>
                        <ul style="list-style:none; padding:0; margin:0 0 20px; display:flex; flex-direction:column; gap:10px;">
                            <li style="display:flex; align-items:center; gap:10px; font-size:.85rem; color:var(--text);">
                        ...
                        <button class="btn btn-primary" id="rs_contactBtn" onclick="notifyContact()" style="height:56px; gap:10px;">
            ...
            renderTriageBannerInternal(lvl);

            let doList = a.do_list || [], dontList = a.dont_list || [];
            renderAdviceBlock('resultAdvice', doList, dontList, lvl);
        ...
        function genRegNumber() {
            ...
            return `CZ-${now.getFullYear()}${pad(now.getMonth() + 1)}${pad(now.getDate())}-${Math.floor(1000 + Math.random() * 9000)}`;
        }
        function escHtml(s) {
         ...
         */
        function renderTriageBannerInternal(lvl) {
            const banner = document.getElementById('resultBanner');
            if (!banner) return;

            let cls = lvl === 'EMERGENCY' ? 'emg' : lvl === 'URGENT' ? 'urg' : 'rtn';

            // Get the translated title from our TX object
            // rs_notified_emg, rs_notified_urg, rs_notified_rtn
            ...
            banner.innerHTML = `
                <div class="triage-banner ${cls}" style="border-radius:20px; text-align:center; padding:24px; margin-bottom:20px; box-shadow: var(--sh);">
                    ...
                    <div style="font-size:0.9rem; opacity:0.9;">
                        ${lvl === 'EMERGENCY' ? 'Medical team has been alerted for your immediate arrival.' : 'Your information has been securely transmitted to the clinical team.'}
                    </div>
                </div>`;

            // If it's an emergency, also ensure the call button is visible
            if (lvl === 'EMERGENCY') {
                const callDiv = document.getElementById('resultEmergencyCall');
                if (callDiv) {
                    callDiv.innerHTML = `
                        <button class="btn btn-danger" style="height:70px; width:100%; margin-bottom:16px; font-weight:900; font-size:1.2rem; display:flex; align-items:center; justify-content:center; gap:10px;" onclick="location.href='tel:112'">
